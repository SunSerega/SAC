...
//ToDo НОООО ИСПРАВИТЬ В ПЕРВУЮ ОЧЕРЕДЬ: почему его не удаляет из блока - откуда его берёт бесконечно растущий блок????
...
// - В DynamicStmBlockRef вообще надо хранить имя начального файла, как уже написано в ToDo в StmParser, ибо проблемы и в других случаях могут быть
