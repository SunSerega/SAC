...
//ToDo разобраться почему лишний раз разворачивает цикл (его продублировало) и почему в конце оказался Return вместо бесконечного цикла
//ToDo [> JumpIf ... "Loop" ... <] не разворачивать
//ToDo добавить IsSame в StmBase
//ToDo хранить имя файла в DynamicStmBlockRef
